...
ECHO Do You Want To Remove All The Bloatware?
SET INPUT=
SET /P INPUT=Please select a number [1 for yes] [2 to skip]
...
:Selection2
ECHO Do You Want A Corruption Scan?

SET INPUT=
SET /P INPUT=Please select a number [1 for yes] [2 to quit]

IF /I '%INPUT%'=='1' GOTO Selection3
IF /I '%INPUT%'=='2' GOTO Selection4
